...
export default function ToursForm() {
  return (
    <form className={styles.root}>
      <Container>
        <fieldset
          className={`${styles.fieldset} ${styles["fieldset_type_inputs"]}`}
        >
          ...
          <div
            className={`${styles.container} ${styles["container_size_wide"]}`}
          >
        ...
        <fieldset
          className={`${styles.fieldset} ${styles["fieldset_type_checkboxes"]}`}
        >
          ...
          <div className={styles.radios}>
            ...
            >
              ...
              />
              <span
                className={`${styles.pseudo} ${styles["pseudo_type_radio"]}`}
              ></span>
              <span>Да</span>
            </label>
            <label
        ...
        <fieldset
          className={`${styles.fieldset} ${styles["fieldset_type_agree"]}`}
        >
          <label className={styles.label} htmlFor="agree">
            ...
            />
            <span
              className={`${styles.pseudo} ${styles["pseudo_type_checkbox"]}`}
            ></span>
          </label>
          <div>
